...
/**
 * Classe que es comunica amb el servidor per a actualizar la informació del servidor quan un client li agrada un producte
 */

public class LikeConnection extends AsyncTask<Product, Void, String> {
    ...
    public BufferedReader like(String parameters) throws IOException {
        ...
        URL url = new URL(Constants.URL_SERVER + Constants.PATH_LIKE + parameters);
