...
/**
 * Gestió de la sessió d'usuris identificats amb email i contrasenya
 */
...
public class SessionManager {
    ...
    public void checkLogin(){
        ...
        if(this.isLoggedIn()){
            ...
            new DownloaderLogin((Activity) _context).execute(pref.getString(KEY_EMAIL, null), pref.getString(KEY_NAME, null));
